 ...
 * `Lang.lean` - the main source for [`cslib.io`](https://cslib.io). This page maps web URLs to specific pages.
...
To edit an existing page, take a look at either [`Lang.lean`](./Lang.lean). Follow the page's address through the definition of the site structure until you discover a Lean module name. 
...
To add a team member, do the following:
 ...
 2. Add their information to one of the specific grounds in [Pages/Team.lean](./Lang/Pages/Governance.lean)
