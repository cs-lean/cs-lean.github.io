...
function initCodeTabs() {
    const tabs = Array.from(document.querySelectorAll('.hero-code-tab')).filter(tab => !tab.classList.contains('filler'));
    const codeSnippets = document.querySelectorAll('.hero-code-snippet');
    const codeTips = document.querySelectorAll('.hero-code-tip');
    const border = document.querySelector('.hero-code-tab-border');
